...
public abstract class ShipEnemy {
	...
	public void update(float delta){
		...
		if(target != null){
			...
			physicsObject.speed.x = HvlMath.stepTowards(physicsObject.speed.x, delta, 0);
			physicsObject.speed.y = HvlMath.stepTowards(physicsObject.speed.y, delta, 0);
		}
